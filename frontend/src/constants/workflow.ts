...
export const WORKFLOW_STAGES: WorkflowStage[] = [
  // 진입점 (프로젝트/임가공 → 수주로 합류)
  { code: 'PROD_PROJECT',     name: '프로젝트', nameEn: 'Project',       icon: 'Building2',      type: 'ENTRY', parentCode: 'PROD_SALES_ORDER', sortOrder: 0 },
  { code: 'PROD_SUBCONTRACT', name: '임가공',   nameEn: 'Subcontract',   icon: 'Handshake',      type: 'ENTRY', parentCode: 'PROD_SALES_ORDER', sortOrder: 0 },
  // 메인 흐름
  { code: 'PROD_SALES_ORDER', name: '수주',     nameEn: 'Order Receipt', icon: 'ClipboardList',  type: 'MAIN', sortOrder: 1 },
  { code: 'PROD_ORDER',       name: '주문',     nameEn: 'Order',         icon: 'ShoppingCart',   type: 'MAIN', sortOrder: 2 },
  { code: 'PROD_PLAN',        name: '생산계획', nameEn: 'Plan',          icon: 'Calendar',       type: 'MAIN', sortOrder: 3 },
  { code: 'PROD_WORK_ORDER',  name: '작업지시', nameEn: 'Work Order',    icon: 'Wrench',         type: 'MAIN', sortOrder: 4 },
  { code: 'PROD_RESULT',      name: '생산실적', nameEn: 'Result',        icon: 'BarChart3',      type: 'MAIN', sortOrder: 5 },
  { code: 'PROD_PACKAGING',   name: '포장',     nameEn: 'Packaging',     icon: 'Package',        type: 'MAIN', sortOrder: 6 },
  { code: 'PROD_SHIPPING',    name: '출고',     nameEn: 'Shipping',      icon: 'Truck',          type: 'MAIN', sortOrder: 7 },
  // 분기 흐름
